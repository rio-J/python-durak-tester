...
def durak_main():
	...
	cutoff = 75
	print ("\n\nTurn: " + str(turn))
	print ("Players hand: " + str(players_hand))
	print ("Comp hand:    " + str(comp_hand))
	...
	while not game_over:
		...
		if attacking == True:
			...
			# If the game isn't ending, stop feeding.
